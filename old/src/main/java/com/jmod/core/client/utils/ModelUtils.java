...
public class ModelUtils {
    ...
    public static @Nonnull BakedQuad createQuad(EnumFacing side, TextureAtlasSprite sprite, int tintIndex, Vector3f from, Vector3f to, float[] uvCoords, ITransformation rotation) {
    ...
    public static @Nonnull BakedQuad createQuad(EnumFacing side, TextureAtlasSprite sprite, int tintIndex, Vector3f from, Vector3f to, ITransformation rotation) {
