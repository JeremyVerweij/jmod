...
public abstract class MetaBlockModel implements IBakedModel {
    ...
    public abstract int getVariantFromState(@NotNull IExtendedBlockState state);

    public abstract int getVariantFromItem(@NotNull ItemStack stack);
    ...
    protected List<BakedQuad> getQuadsFromExtendedState(@NotNull IExtendedBlockState state, @Nullable EnumFacing side, long rand){
    ...
    @Override public ItemOverrideList getOverrides() {
        return new ItemOverrideList(Collections.emptyList()){
            @Override
            public IBakedModel handleItemState(@NotNull IBakedModel originalModel, @NotNull ItemStack stack, @Nullable World world, @Nullable EntityLivingBase entity) {
