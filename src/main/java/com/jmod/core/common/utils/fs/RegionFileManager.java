...
public class RegionFileManager {
    ...
    private static void writeChunkDataAtPosAndSetPointer(ByteBuffer buffer, FileChannel channel,
                                                         int offset, int fileSize, int writePos, @NotNull ByteBuffer size) throws IOException {
        size.flip();
    ...
    private static int getPointerInt(@NotNull FileChannel channel, int offset) throws IOException {
    ...
    public static void compactRegion(@NotNull Path filePath) throws IOException {
