package com.jmod.jrender.client.render;
...
import com.jmod.jrender.client.render.chunk.ChunkRenderManager;
import com.jmod.jrender.client.render.chunk.backends.multidraw.MultidrawChunkRenderBackend;
import com.jmod.jrender.client.render.chunk.backends.oneshot.ChunkRenderBackendOneshot;
import com.jmod.jrender.client.render.chunk.data.ChunkRenderData;
import com.jmod.jrender.client.render.chunk.format.DefaultModelVertexFormats;
...
import com.jmod.jrender.client.render.pipeline.context.ChunkRenderCacheShared;
import com.jmod.jrender.client.util.math.FrustumExtended;
import com.jmod.jrender.client.world.ChunkStatusListener;
import com.jmod.jrender.client.world.ChunkStatusListenerManager;
import com.jmod.jrender.common.util.ListUtil;
...
public class SodiumWorldRenderer implements ChunkStatusListener {
    ...
    public void updateChunks(Frustum frustum, float ticks, boolean hasForcedFrustum, int frame, boolean spectator) {
        ...
        this.useEntityCulling = JRender.options().advanced.useEntityCulling;
    ...
    private void initRenderer() {
        ...
        SodiumGameOptions opts = JRender.options();
    ...
    private static ChunkRenderBackend<?> createChunkRenderBackend(RenderDevice device,
        ...
        boolean disableBlacklist = JRender.options().advanced.ignoreDriverBlacklist;
    ...
    private void renderTE(TileEntity tileEntity, int pass, float partialTicks, int damageProgress) {
        ...
        try {
            ...
            if(tileEntity.isInvalid()) {
                JRender.logger().error("Suppressing crash from invalid tile entity", e);
            } else {
                throw e;
            }
        }
