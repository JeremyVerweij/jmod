...
import com.jmod.jrender.client.render.chunk.backends.multidraw.MultidrawChunkRenderBackend;
import com.jmod.jrender.client.render.chunk.compile.ChunkBuildResult;
import com.jmod.jrender.client.render.chunk.compile.ChunkBuilder;
import com.jmod.jrender.client.render.chunk.cull.ChunkCuller;
import com.jmod.jrender.client.render.chunk.cull.ChunkFaceFlags;
import com.jmod.jrender.client.render.chunk.cull.graph.ChunkGraphCuller;
import com.jmod.jrender.client.render.chunk.data.ChunkRenderBounds;
import com.jmod.jrender.client.render.chunk.data.ChunkRenderData;
import com.jmod.jrender.client.render.chunk.lists.ChunkRenderList;
...
import com.jmod.jrender.client.util.math.MathChunkPos;
import com.jmod.jrender.client.world.ChunkStatusListener;
import com.jmod.jrender.common.util.DirectionUtil;
import com.jmod.jrender.common.util.IdTable;
import com.jmod.jrender.common.util.collections.FutureDequeDrain;
...
public class ChunkRenderManager<T extends ChunkGraphicsState> implements ChunkStatusListener {
    ...
    public ChunkRenderManager(SodiumWorldRenderer renderer, ChunkRenderBackend<T> backend, BlockRenderPassManager renderPassManager, WorldClient world, int renderDistance) {
        ...
        this.translucencySorting = JRender.options().advanced.translucencySorting;
        this.translucencyBlockRenderDistance = Math.min(9216, (renderDistance << 4) * (renderDistance << 4));

        this.useBlockFaceCulling = JRender.options().advanced.useBlockFaceCulling;
    }
    ...
    private void setup(float ticks) {
        ...
        this.alwaysDeferChunkUpdates = JRender.options().performance.alwaysDeferChunkUpdates;

        if (JRender.options().advanced.useFogOcclusion) {
