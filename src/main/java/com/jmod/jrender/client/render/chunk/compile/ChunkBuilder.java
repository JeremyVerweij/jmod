...
import com.jmod.jrender.client.render.chunk.tasks.ChunkRenderBuildTask;
import com.jmod.jrender.client.render.chunk.tasks.ChunkRenderEmptyBuildTask;
import com.jmod.jrender.client.render.chunk.tasks.ChunkRenderRebuildTask;
import com.jmod.jrender.client.render.chunk.tasks.ChunkRenderTranslucencySortTask;
import com.jmod.jrender.client.render.pipeline.context.ChunkRenderCacheLocal;
import com.jmod.jrender.client.util.task.CancellationSource;
import com.jmod.jrender.client.world.WorldSlice;
import com.jmod.jrender.client.world.cloned.ChunkRenderContext;
import com.jmod.jrender.client.world.cloned.ClonedChunkSectionCache;
import com.jmod.jrender.common.util.collections.DequeDrain;
...
public class ChunkBuilder<T extends ChunkGraphicsState> {
    ...
    private static int getThreadCount() {
        int requested = JRender.options().performance.chunkBuilderThreads;
        ...
        public void run() {
            ...
            while (this.running.get()) {
                ...
                try {
                    ...
                    JRender.logger().error("Chunk build failed", e);
                    continue;
                } finally {
