...
public class ColorRGBA {
    ...
    private static final byte ALPHA_SHIFT = (byte) 0;
    private static final byte RED_SHIFT = (byte) 24;
    private static final byte GREEN_SHIFT = (byte) 16;
    private static final byte BLUE_SHIFT = (byte) 8;
    ...
    public static int invertBytes(int color){
        return ColorRGBA.unpackAlpha(color) << 24 | ColorRGBA.unpackBlue(color) << 16 | ColorRGBA.unpackGreen(color) << 8 | ColorRGBA.unpackRed(color);
    }
}
