package com.jmod.jrender.mod.world.lighting;

import com.jmod.jrender.JRender;
import com.jmod.jrender.api.IChunkLighting;
import com.jmod.jrender.api.IChunkLightingData;
import com.jmod.jrender.api.ILightingEngine;
import com.jmod.jrender.api.ILightingEngineProvider;
    ...
    public static void readNeighborLightChecksFromNBT(final Chunk chunk, final NBTTagCompound nbt) {
        if (nbt.hasKey(neighborLightChecksKey, 9)) {
            ...
            if (list.tagCount() == FLAG_COUNT) {
                ...
                JRender.LOGGER.warn("Chunk field {} had invalid length, ignoring it (chunk coordinates: {} {})", neighborLightChecksKey, chunk.x, chunk.z);
            }
        }
    }
